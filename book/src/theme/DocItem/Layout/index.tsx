...
import PersonalizationControls from '@site/src/components/PersonalizationControls';
import TranslationSwitcherButton from '@site/src/components/TranslationSwitcherButton';
        ...
        <div className={clsx('col', !docTOC.hidden && styles.docItemCol)}>
          ...
          <div className={styles.docItemContainer}>
            <article>
              ...
              {/* Controls Bar - Just above content */}
